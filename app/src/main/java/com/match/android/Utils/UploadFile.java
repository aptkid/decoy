...
public class UploadFile {
    ...
    public UploadFile(OSS client, String bucket, String object, String uploadFilePath) {
        this.oss = client;
        this.bucket = bucket;
        this.object = object;
    ...
    public void resumableUploadWithRecordPathSetting() {
        ...
        ResumableUploadRequest request = new ResumableUploadRequest(bucket, object, uploadFilePath, recordDirectory);
        // 设置上传过程回调
        request.setProgressCallback(new OSSProgressCallback<ResumableUploadRequest>() {
            @Override
            public void onProgress(ResumableUploadRequest request, long currentSize, long totalSize) {
    ...
    public void uploadData(FileOutputStream file){
        // 构造上传请求
        PutObjectRequest put = new PutObjectRequest(bucket, object, String.valueOf(file));
        try {
